...
def declare_result_view(request):
    ...
    if request.method == "POST":
        ...
        select_class_id = data['select_class']  # Extracting the ID properly
        select_student_id = data['select_student']  # Extracting the ID properly
        clas = StudentClass.objects.get(id=select_class_id)
        student = Student.objects.get(id=select_student_id)
